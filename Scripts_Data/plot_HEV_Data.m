...
for pc_ind = 1:length(PlotChoice)
    if PlotChoice(pc_ind) == 'D'
        ...
        plot(DT_Time(1:DT_maxind),DT_Data(1:DT_maxind),DT_style,'LineWidth',4);%PlotLineWidth);
    elseif PlotChoice(pc_ind) == 'S'
        ...
        plot(SY_Time(1:SY_maxind),SY_Data(1:SY_maxind),SY_style,'LineWidth',3)%PlotLineWidth);
   elseif PlotChoice(pc_ind) == 'M'
        ...
        plot(MV_Time(1:MV_maxind),MV_Data(1:MV_maxind),MV_style,'LineWidth',1);%,PlotLineWidth);
    else
