...
using Simscape Power Systems alone, there are two reasons why we did not use this.
   ...
   2. The Total Harmonic Distortion block in Simscape Power Systems is only for AC networks.
